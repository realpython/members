    ...
    var chapterLessons = [
      {
        ...
        lessonContent: '<h1>This should be an H1</h1>',
        lessonRead: false,
      ...
      },
      {
        ...
        lessonContent: '<h1>Lesson 1c</h1><p>Lomo poutine tousled, dreamcatcher marfa salvia craft beer man braid austin kogi stumptown food truck blue bottle tacos humblebrag.</p><ol><li>Fashion axe tote bag cornhole drinking vinegar.</li><li>Selfies art party banjo, pork belly paleo PBR&B wayfarers butcher.</li> <li>Gastropub crucifix artisan, salvia butcher ennui gentrify seitan irony knausgaard tofu.</li><li>Meggings fixie mlkshk locavore beard slow-carb.</ol><p>Synth tumblr salvia cliche hella, celiac whatever shoreditch four loko. VHS whatever pickled pug, sartorial you probably haven\'t heard of them bushwick disrupt food truck etsy letterpress iPhone cornhole kogi.</p>',
        lessonRead: false,
        chapterOrder: chapterOrder[0],
        lessonActive: true
      },
      {
        ...
        lessonContent: '<h1>Lesson 1d</h1><a href="https://realpython.com">Lomo poutine tousled, dreamcatcher marfa salvia craft beer man braid austin kogi stumptown food truck blue bottle tacos humblebrag. Fashion axe tote bag cornhole drinking vinegar.</a><p><strong>Selfies art party banjo, pork belly paleo PBR&B wayfarers butcher. Gastropub crucifix artisan, salvia butcher ennui gentrify seitan irony knausgaard tofu. Meggings fixie mlkshk locavore beard slow-carb. Synth tumblr salvia cliche hella, celiac whatever shoreditch four loko. VHS whatever pickled pug, sartorial you probably haven\'t heard of them bushwick disrupt food truck etsy letterpress iPhone cornhole kogi.</strong>',
        lessonRead: false,
        chapterOrder: chapterOrder[0],
        lessonActive: false
      },
